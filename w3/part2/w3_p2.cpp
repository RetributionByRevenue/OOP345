...
int main(int argc, char* argv[]) {
	...
	//     Sumation means mathematical addition of numbers.
	{
		...
		std::cout << "Student Tickets  = " << std::setw(7) << ticketSales.accumulate("Student") * studentFare
			<< std::endl;
		std::cout << "  Adult Tickets  = " << std::setw(7) << ticketSales.accumulate("Adult") * adultFare << std::endl;
		std::cout << " Senior Tickets  = " << std::setw(7) << ticketSales.accumulate("Senior") * seniorFare
			<< std::endl;
	}
